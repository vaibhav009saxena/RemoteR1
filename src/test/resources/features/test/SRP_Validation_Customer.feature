...
@regression @SrpCustomervalidation

Feature: SRP page validation
  As a Customer I want to validate the SRP page validation
  So that it works as expected during booking journey

  @SrpCustomervalidation-01
  Scenario Outline:Verify on click of Indigo logo.
    ...
    Examples:
      |adult_count |senior_citizen_count |children_count |infant_count |origin   |destination   |date           |user_type              |username          |password|
      | 1          |   0                 |        0      |   0         |DEL      |   MUM        |30 Jun 2023    |Customer Login         |9766940710        |Indigo@123         |

  @SrpCustomervalidation-02
  Scenario Outline:  Verify that modification result only visible after clicks on modify button.
    ...
    Examples:
      | trip_type | origin | destination | date        | srp_trip_type | srpOrigin | srpDestination | departureDate | arrivalDate | adult | seniorCitizen | children | special_fare | expectedSpecialFare  |user_type              |username          |password|
      | One Way   | DEL    | MUM         | 28 Jun 2023 | Round Trip    | DEL       | HYD            | 17 Jun 2023   | 20 Aug 2023 | 4     | 0             | 3        | Students     | STUDENTS FARE        |Customer Login         |9766940710        |Indigo@123         |

  @SrpCustomervalidation-03
  Scenario Outline:  Verify that "add return trip" will be disabled for one way trip.
    ...
    Examples:
      |origin                |destination       |date             |trip_type       |srp_trip_type |srp_trip_types |user_type              |username          |password|
      | DEL                  |  MUM             | 30 Jun 2023     | One Way        |  One Way     |  Round Trip   |Customer Login         |9766940710        |Indigo@123         |

  @SrpCustomervalidation-04
...
#    And user verify close button after clicks on add city button
    ...
    Examples:
      | trip_type | origin | destination | date          |srp_trip_type |fare_type|user_type              |username          |password|
      | One Way   | DEL    | MUM         | 10 Jun 2023   |Multi-city    |Saver    |Customer Login         |9766940710        |Indigo@123         |

  @SrpCustomervalidation-05
  Scenario Outline: Verify that we should get fare combination popup on selecting different fare for round trip booking
    ...
    Examples:
      | trip_type  | origin | destination | departureTraveldate | arrivalTraveldate | fare_type | return_fare_type |user_type              |username          |password|
      | Round Trip | DEL    | MUM         |  29 Jun 2023        | 30 Jun 2023     | Saver     | Flexi              |Customer Login         |9766940710        |Indigo@123         |

  @SrpCustomervalidation-06
  Scenario Outline:  Verify that we are allowed to search multicity flights on SRP page.
    Given user opens the Indigo website
    And login as user "<user_type>", enter "<username>" and "<password>"
    When user selects the trip type as "<trip_type>"
    ...
    Examples:
      | trip_type | origin | destination | date          |srp_trip_type |fare_type|adult_count|senior_citizen_count|children_count|infant_count|fare_type2     |user_type              |username          |password|
      | One Way   | DEL    | MUM         | 15 Jun 2023   |Multi-city    |Saver    |    1      |        0           |     0        |  0         | Flexi         |Customer Login         |9766940710        |Indigo@123         |

  @SrpCustomervalidation-07
  Scenario Outline: Verify that we should get fare combination popup on selecting different fare  for round trip booking
    Given user opens the Indigo website
    And login as user "<user_type>", enter "<username>" and "<password>"
    When user selects the trip type as "<trip_type>"
  ...
  Scenario Outline: flexi plus fare popup should be appears on selecting saver fare type
    ...
    Examples:
      | origin | destination | date        | fare_type | mobile_number | mail_id           |user_type              |username          |password|
      | DEL    | MUM         | 30 Jun 2023 | Saver     | 9900990090    | johndoe@gmail.com |Customer Login         |9766940710        |Indigo@123         |

  @SrpCustomervalidation-09
  Scenario Outline: flexi plus fare popup should not be appears on selecting fare type other than saver
    ...
    Examples:
      | origin | destination | date        | fare_type | mobile_number    | mail_id           |user_type              |username          |password|
      | DEL    | MUM         | 30 Jun 2023 | Super 6E     | 9900990090    | johndoe@gmail.com |Customer Login         |9766940710        |Indigo@123         |

  @SrpCustomervalidation-10
  Scenario Outline: Validate the user see the difference in price between saver and  flexi fare in flexi upsell popup
    ...
    Examples:
      | origin | destination | date        | fare_type | mobile_number | mail_id           |user_type              |username          |password|
      | HYD    | CCU         | 30 Jun 2023 | Saver     | 9900990090    | johndoe@gmail.com |Customer Login         |9766940710        |Indigo@123         |

  @SrpCustomervalidation-11
  ...
  @SrpCustomervalidation-12 @srpvalidrerun
  Scenario Outline: User verify the footer details while taking round trip
    ...
    Examples:
      | trip_type  | origin | destination | departureTraveldate | arrivalTraveldate | fare_type | return_fare_type   |user_type              |username          |password|
      | Round Trip | DEL    | MUM         |  15 Jun 2023        | 30 Jun 2023       | Saver     | Saver              |Customer Login         |9766940710        |Indigo@123         |

  @SrpCustomervalidation-13
  Scenario Outline:  Verify the continue button functionality for round trip disable(Select departure flight) Enable (Select return flight)
    ...
    Examples:
      |trip_type          |origin   |destination|departureTraveldate|fare_type     |arrivalTraveldate|user_type              |username          |password|
      |  Round Trip       |  DEL    |    MUM    |  15 Jun 2023      | Saver        | 30 Jun 2023     |Customer Login         |9766940710        |Indigo@123         |

  @SrpCustomervalidation-14
  Scenario Outline:  Verify the continue button functionality for round trip disable(Select departure flight) Enable (Select return flight)
    Given user opens the Indigo website
    And login as user "<user_type>", enter "<username>" and "<password>"
    When user selects the trip type as "<trip_type>"
    ...
    And Verify the continue button functionality for round trip "<fare_type>"
    Examples:
      |trip_type          |origin   |destination|fare_type     |date           |srp_trip_type|user_type              |username          |password|
      |  One Way          |  DEL    |    MUM    | Saver        | 15 Jun 2023   | Multi-city  |Customer Login         |9766940710        |Indigo@123         |

  @SrpCustomervalidation-15
  Scenario Outline: Validate that show more flight option should be visible and other flight data are shown
    ...
    Examples:
      | origin | destination | date            | fare_type |user_type              |username          |password|
      | DEL    | MUM         |  15 Jun 2023    | Saver     |Customer Login         |9766940710        |Indigo@123         |

  @SrpCustomervalidation-16
...
#      | All      |
  ...
  Scenario Outline: Verify the price are arranged in Descending order
    ...
    Examples:
      ...
      | DEL    | MUM         | 10 Aug 2023     |Customer Login         |9766940710        |Indigo@123         |

  @SrpCustomervalidation-19
  ...
  Scenario Outline: Verify price between Total fare and fare breakup including Fare+tax after clicks on details button
    ...
    Examples:
      | origin | destination     | date                |fare_type     |user_type              |username          |password|
      | DEL      | MUM           | 10 Aug 2023         | Saver        |Customer Login         |9766940710        |Indigo@123         |

  @SrpCustomervalidation-21
  Scenario Outline: Verify breakup price and total fare price are equal for Roundtrip details.
    ...
    Examples:
      | trip_type  | origin | destination | departureTraveldate | arrivalTraveldate | fare_type | return_fare_type  |user_type              |username          |password|
      | Round Trip | DEL    | MUM         | 15 Jun 2023         |  25 Jun 2023       | Saver     | Saver            |Customer Login         |9766940710        |Indigo@123         |

  @SrpCustomervalidation-22
  ...
  Scenario Outline: user should redirect to the next page on clicks on 'Skip & continue with saver fare' button on the flexi plus popup
    ...
    Examples:
      | trip_type | origin | destination | date          | fare_type|mobile_number|mail_id            |user_type              |username    |password  |
      | One Way   | DEL    | MUM         | 15 Jun 2023   | Saver    | 8668399124  | abhi@gmail.com    |Customer Login         |9766940710  |Indigo@123|

  @SrpCustomervalidation-26
  Scenario Outline: Verify that we are only able to see selected time filter flight on SRP
    ...
    Examples:
      | origin | destination |  trip_type  | onward_time_filter | return_time_filter |departureTraveldate |arrivalTraveldate|user_type              |username          |password  |
#      | DEL    | MUM          | Round Trip | 18-00              | 18-00              |    10 May 2023     |    12 May 2023  |
      | DEL    | MUM         | Round Trip | 18-00              | 00-06              |15 Jun 2023     |    25 Jun 2023       |Customer Login         |9766940710        |Indigo@123|
#      | DEL    | MUM          | Round Trip | 18-00              | 06-12              |10 May 2023     |    12 May 2023  |
#      | DEL    | MUM          | Round Trip | 18-00              | 12-18              |10 May 2023     |    12 May 2023  |

  @SrpCustomervalidation-27
  Scenario Outline: Verify the login pop up at SRP page when user is already login with members
    ...
    Examples:
      ...
      | One Way   | DEL    | MUM         | 15 Jun 2023     | 9766940710 | Indigo@123 |Customer Login|

  @SrpCustomervalidation-28
  ...
  Scenario Outline: Verify the contact detail popup on SRP page
    ...
    Examples:
      | user_type        | username    | password     | trip_type | origin | destination | date         | fare_type  | incorrect_mobile_number | incorrect_mail_id   | Country Code | mobile_number | mail_id       | GST_NUMBER      |   GST_Email      |  CompanyName      |
      | Customer Login   | 8999178412  | Indigo@78    |  One Way  | DEL    | MUM         | 22 Jun 2023  | Saver      | 900009000               | bsajsnsn@gmwshjj    | +93          | 9000009000    | abc@gmail.com | GSTINJD12345678 |   JD@gmail.com   |   JD Group        |
  ...
  Scenario Outline: Verify the travel guidelines pop up
    ...
    Examples:
      | user_type        | username    | password     | infant_count | children_count | adult_count | senior_citizen_count | origin | destination | date        | fare_type  |trip_type|
      | Customer Login   | 8999178412  | Indigo@78    | 0            | 0              | 1           | 0                    | DEL    | DOH         | 22 Jun 2023 | Saver      | One Way |
  ...
  Scenario Outline:Verify the cross button functionality in nationality popup
    ...
    Examples:
      | user_type        | username    | password        | trip_type | origin | destination | date         | srpOrigin | srpDestination |
      | Customer Login   | 8999178412  | Indigo@78       | One Way   | DEL    | MUM         | 22 Jun 2023  | MLE       | DEL            |
  ...
  Scenario Outline: Verify the nationality popup for the other destination
    ...
    Examples:
      | user_type        | username    | password        | trip_type | origin | destination | date         | srpOrigin | srpDestination |
      | Customer Login   | 8999178412  | Indigo@78       | One Way   | DEL    | MUM         | 22 Jun 2023  | AMD       | MUM            |
  ...
  Scenario Outline: Verify that terminal change pop up is appearing in case of flight change
    ...
    Examples:
      | user_type        | username    | password     | trip_type | origin | destination | date        | fare_type |
      | Customer Login   | 8999178412  | Indigo@78    | One Way   | BLR    | RUH         | 22 Jun 2023 | Saver     |
  ...
  Scenario Outline: Verify the terminal change process in case of Non-Stop sector
    ...
    Examples:
      | user_type        | username    | password      | trip_type | origin | destination | date        | fare_type |
      | Customer Login   | 8999178412  | Indigo@78     | One Way   | COK    | MLE         | 22 Jun 2023 | Saver     |
  ...
  Scenario Outline: Verify the various fare type at srp page
    ...
    Examples:
      | user_type        | username    | password     | trip_type | origin | destination | date        |
      | Customer Login   | 8999178412  | Indigo@78    | One Way   | DEL    | MUM         | 22 Jun 2023 |
