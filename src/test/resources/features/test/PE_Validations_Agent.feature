#Author: NidhiG
@smoke @regression  @ValidatePassengerEditagentuser

Feature: Passenger Edit Agent
  As a user I want to validate the Passenger Edit
  So that it works as expected during booking journey

  @PE-ValidationEdit-Agent-01
...
#    And user click on Login button on Passenger Edit page
    ...
    Examples:
   |infant_count  |children_count |senior_citizen_count| adult_count | username | password      | origin | destination | date           | fare_type| mobile_number  | mail_id             |trip_type|
   |   0           |     0        |       0            |  0          | testweb  | Indigo@00010001  | DEL    | CCU         |  27 Jun 2023   | Saver    | 9900990090     | johndoe@gmail.com   |One Way   |

  @PE-ValidationEdit-Agent-02
  Scenario Outline: Verify Armed force personnel ID pop up
    ...
    Examples:
      | username | password     | adult_count | senior_citizen_count | children_count | infant_count | special_fare | origin | destination | date        | fare_type | mobile_number | mail_id           | prefix | first_Name                     | last_Name                        | Personal ID |
      | testweb  | Indigo@0001  |  1          | 0                    | 0              | 0            | Armed Forces | DEL    | MUM         | 30 Jun 2023 | Saver     | 9900990090    | johndoe@gmail.com | MR     | Adolph Blaine Charles Davidson | William Xerxes Yancy Zeus Barnes | 12345       |

  @PE-ValidationEdit-Agent-03
  Scenario Outline:Verify Student ID popup
    ...
    Examples:
        |children_count | senior_citizen_count | username | password       | adult_count | infant_count | origin | destination | date             | mobile_number | mail_id           |  fare_type|special_fare     |StudentId  |collagename|
         |       0       |            0          | testweb  | Indigo@0001   | 1           | 0            | MUM    | DEL         | 30 Jun 2023      | 90009000900   | johndoe@gmail.com |  Saver    |  Students       | SUID12345 | SYMBOISIS |

  @PE-ValidationEdit-Agent-04 @validatestudent
  Scenario Outline:Verify user can skip Student ID popup
    ...
    Examples:
      |children_count | senior_citizen_count    | username | password       | adult_count | infant_count | origin | destination | date             | mobile_number | mail_id           |  fare_type|special_fare     |
      |       0       |        0                 | testweb  | Indigo@0001    | 1           | 0            | MUM    | DEL         | 30 Jun 2023      | 90009000900   | johndoe@gmail.com |  Saver    |  Students       |

  @PE-ValidationEdit-Agent-05 @doctorNew
  Scenario Outline:Verify Doctor/Nurses ID popup
    ...
    Examples:
      | username | password | adult_count | infant_count |senior_citizen_count| children_count  |      origin | destination | date             | mobile_number | mail_id           |  fare_type|special_fare       |hospitalId|
      | testweb  | Indigo@0001 | 2           | 0            |       0            |        0        |      MUM    | DEL         | 24 Jun 2023      | 90009000900   | johndoe@gmail.com |  Saver    |  Doctors & Nurses | Dr1234   |

  @PE-ValidationEdit-Agent-06
  Scenario Outline: Double/Triple seat tagging change popup.
    ...
    Examples:
      | username | password   | adult_count | senior_citizen_count | children_count | infant_count | origin | destination | date         | fare_type | mobile_number | mail_id           |
      | testweb  | Indigo@0001|  2          |       0              | 0             |0             | DEL    | MUM         | 30 Jun 2023  | Saver     | 9900990090    | johndoe@gmail.com |


  @PE-ValidationEdit-Agent-07 @NameFiled
  Scenario Outline: Verify the adult passenger information
    ...
    Examples:
      | username | password      | adult_count | senior_citizen_count | children_count | infant_count | origin | destination | date         | fare_type | mobile_number | mail_id           |
      | testweb  | Indigo@0001   |  1          |       0              | 0             |0              | DEL    | MUM         | 20 Jun 2023  | Saver     | 9900990090    | johndoe@gmail.com |

  @PE-ValidationEdit-Agent-08
  Scenario Outline:  Unaccompained minor
    ...
    Examples:
      | username | password    |special_fare           | adult_count | senior_citizen_count | children_count | infant_count | origin | destination | date         | fare_type | mobile_number | mail_id           |
      | testweb  | Indigo@0001 |Unaccompanied Minor    |  1          |       0              | 0             |0              | DEL    | MUM         | 20 Jun 2023  | Saver     | 9900990090    | johndoe@gmail.com |
  ...
  Scenario Outline:validate infant information
    ...
    Examples:
      | username | password     |children_count  |senior_citizen_count | infant_count | adult_count |  origin | destination | date           | mobile_number | mail_id            | prefix | first_Name                     | last_Name                        | date_of_birth_infant | infant_gender | fare_type | index_of_adult_for_infant_tag |
      | testweb  | Indigo@0001  |    0           |        0             | 1            | 1           |  DEL    | CCU        | 27 Jun 2023    | 90009000900   | johndoe@gmail.com  | Mr     | Adolph Blaine Charles Davidson | William Xerxes Yancy Zeus Barnes | 14-May-2023          | male          | Saver     | 1                             |



  @PE-ValidationEdit-Agent-10
  Scenario Outline: Verify the adult ,passenger information with passport details
    ...
    Examples:
      | username | password   |PassportNumber | adult_count | senior_citizen_count | children_count | infant_count | origin | destination | date         | fare_type | mobile_number | mail_id           |
      | testweb  | Indigo@0001 |BA3557524096   |  1          |       0              |  0            |0              | DOH    | DEL         | 10 Jun 2023  | Saver     | 9900990090    | johndoe@gmail.com |

  @PE-ValidationEdit-Agent-11
  Scenario Outline: Verify the child  passenger information
    ...
    Examples:
      | username | password    |PassportNumber | adult_count | senior_citizen_count | children_count | infant_count | origin | destination | date         | fare_type | mobile_number | mail_id           |
      | testweb  | Indigo@0001 |BA3557524096   |  0          |       0              |  1             |0              | DOH    | MUM         | 10 Jun 2023  | Saver     | 9900990090    | johndoe@gmail.com |

  @PE-ValidationEdit-Agent-12
  Scenario Outline: Validate the fields for senior citizen
    ...
    Examples: Validation of fields of senior citizen and infant
      | username | password      | children_count    |adult_count     | infant_count | senior_citizen_count | origin | destination | date             |  mobile_number | mail_id           | prefix | first_Name         | last_Name             | date_of_birth_senior |  fare_type |   SCID     |
      | testweb  | Indigo@0001   |       0           |      0         | 0            | 1                    | DEL    | CCU         | 27 Jun 2023      |  90009000900   | johndoe@gmail.com | Mr     | Adolph Blaine Charl| William Xerxes Yancy  | 14-Jun-1962          |  Saver     |   SC12345   |

  @PE-ValidationEdit-Agent-13
...
#   Then Verify the sector fare details and fare breakup
    ...
    Examples:
      | username | password   |children_count    | senior_citizen_count | adult_count | infant_count | origin | destination  | date             | mobile_number | mail_id           |  fare_type|
      | testweb  | Indigo@0001 |      0           |      0                | 1           | 0            | MUM    | DEL         | 30 Jun 2023      | 90009000900   | johndoe@gmail.com |  Saver    |


  @PE-ValidationEdit-Agent-14
...
#    Examples:
#      | username | password         |children_count    | senior_citizen_count | adult_count | infant_count | origin | destination  | date             | mobile_number | mail_id           |  fare_type   |
#        | testweb|      Indigo@0001 |      0           |      1               | 1           | 0            | MUM    | DEL          | 30 Jun 2023      | 90009000900   | johndoe@gmail.com | Flexi Plus   |

  @PE-ValidationEdit-Agent-16
  Scenario Outline: Verify that Orange banner message When user selected Saver fare on SRP for with senior citizen(Negative)
    ...
    Examples:
      | username | password      |children_count    | senior_citizen_count | adult_count | infant_count | origin | destination  | date             | mobile_number | mail_id           |  fare_type   |
     |  testweb   |   Indigo@0001 |      0           |      1               | 0           | 0            | MUM    | DEL          | 30 Jun 2023      | 90009000900   | johndoe@gmail.com | Saver        |


#      @PE-ValidationEdit-Agent-17
#      Scenario Outline: Verify that Orange banner message with non discounted fare (Agent login)
#      Given user opens the Indigo Agent url
#      And user enter "<username>" and "<password>"
#      When user agent adds adult count as <adult_count>, senior citizen count as <senior_citizen_count>, children count as <children_count> and infant count as <infant_count>
#      And user searches for a flight on homepage from "<origin>" to "<destination>" on date "<date>"
...
#      Examples:
#      |username     | password     |children_count    | senior_citizen_count | adult_count | infant_count | origin | destination  | date             | mobile_number | mail_id           |  fare_type   |
#      | testweb     |Indigo@0001   |      0           |      1               | 0           | 0            | MUM    | DEL          | 30 Jun 2023      | 90009000900   | johndoe@gmail.com | Flexi Plus   |


  @PE-ValidationEdit-Agent-18
  Scenario Outline: Validate the wheelchair assistance form can be submitted by senior, adults and children
    ...
    Examples: Validate wheelchair section
      | username    | password     | index_of_adult_for_infant_tag | infant_count | children_count | adult_count | senior_citizen_count | origin | destination | date           | fare_type| mobile_number         | mail_id           |trip_type|
      | testweb     |Indigo@0001| 1                             | 1           | 1               | 2           | 1                     | DEL    | MUM         |  28 Jun 2023   | Saver    | 9900990090            | johndoe@gmail.com |One Way   |

  @PE-ValidationEdit-Agent-19
  Scenario Outline: Verify that sub category option will be depended on Category selection in medical reason radio button
    ...
    And click on continue user should be able to move onto addons section
    Examples: Validate wheelchair section
      | username | password  | infant_count | children_count | adult_count | senior_citizen_count | origin | destination | date           | fare_type| mobile_number  | mail_id           |trip_type|
      | testweb     |Indigo@0001| 0             | 0               | 0            | 1                     | DEL    | MUM         |  30 Jun 2023    | Saver    | 9900990090 | johndoe@gmail.com |One Way   |

  @PE-ValidationEdit-Agent-20
  Scenario Outline: Verify Pop-up and fields Infant not Named, Change button for Infant Tagging Change
    ...
    Examples:
      | username | password | children_count | adult_count | infant_count | senior_citizen_count | origin | destination | date | mobile_number | mail_id                       | prefix | first_Name                     | last_Name                        | date_of_birth_infant | infant_gender   | fare_type| index_of_adult_for_infant_tag| new_index_of_adult_for_infant_tag |
       | testweb   |Indigo@0001 | 0              | 1           | 1            | 1                    | MUM    | DEL         | 30 Jun 2023      | 90009000900   | johndoe@gmail.com | MR     | Adolph Blaine Charles Davidson | William Xerxes Yancy Zeus Barnes | 14-Jun-2022          | Male           | Saver     | 1                             | 1                                 |

  @PE-ValidationEdit-Agent-21
  Scenario Outline: To Verify popup will appear when user try to add the tagging of extra seat from current passenger to another passenger
    ...
    Examples:
      | username | password  | infant_count | children_count | adult_count | senior_citizen_count | origin | destination | date | fare_type | mobile_number | mail_id           |
       |testweb  | Indigo@0001 | 0            | 0              | 2           | 1                    | DEL     | MUM         |  28 Jun 2023    | Saver     | 9900990090    | johndoe@gmail.com |

  @PE-ValidationEdit-Agent-22
  Scenario Outline:Verify Review summary
    ...
    Examples:
      | username   | password | infant_count | children_count | adult_count | senior_citizen_count | origin | destination | date | fare_type | mobile_number | mail_id           |
      |Indigo@0001 | testweb  | 0            | 0              | 1         | 0                    | DEL     | MUM         |  28 Jun 2023    | Saver     | 9900990090    | johndoe@gmail.com |

  @PE-ValidationEdit-Agent-23
  Scenario Outline: Verify the passenger details to be filled from the favourite list
    ...
    Examples:
      |password    |username   | infant_count | children_count | adult_count | senior_citizen_count | origin  | destination | date            | fare_type | mobile_number | mail_id           |
      |Indigo@0001 | testweb   | 0            | 0              | 2          | 0                    | DEL     | MUM         |  28 Jun 2023    | Saver     | 9900990090    | johndoe@gmail.com |

  @PE-ValidationEdit-Agent-24
  ...
  Scenario Outline:Verify that infant year should not be more then two years
    ...
    Examples:
      | username | password     |children_count  |senior_citizen_count | infant_count | adult_count |  origin | destination | date           | mobile_number | mail_id            | prefix | first_Name                     | last_Name                        | date_of_birth_infant | infant_gender | fare_type | index_of_adult_for_infant_tag |
      |Indigo@0001 | testweb |    0           |        0             | 1            | 1           |  DEL    | CCU        | 27 Jun 2023    | 90009000900   | johndoe@gmail.com  | Mr     | Adolph Blaine Charles Davidson | William Xerxes Yancy Zeus Barnes | 14-May-2023          | male          | Saver     | 1                             |

  @PE-ValidationEdit-Agent-26
  Scenario Outline: Verify that in multi city booking day,month and date heading should be displayed
    ...
    Examples:
      | username | password  | trip_type | origin | destination | date          |srp_trip_type |fare_type|mobile_number  |mail_id          |
      |Indigo@0001 | testweb| One Way   | DEL    | MUM         | 15 Jun 2023   |Multi-city    |Saver    | 9876456777    |abhii@gmail.com  |
