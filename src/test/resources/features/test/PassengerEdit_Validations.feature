#Author: NidhiG
@smoke @regression @agentuser @homePage @ValidatePassengerEdit
    ...
    Examples:
      | origin | destination | date           | fare_type| mobile_number  | mail_id             |trip_type|
      | DEL    | CCU         |  27 Jun 2023   | Saver    | 9900990090     | johndoe@gmail.com   |One Way   |
...
#    And user enter the studentId "<StudentId>" and collage name "<collagename>" and user click on continue btn
    ...
    Examples:
      ...
      | 2           | 0            |       0            |        0        |      MUM    | DEL         | 24 Jun 2023      | 90009000900   | johndoe@gmail.com |  Saver    |  Doctors & Nurses | Dr1234   |
    ...
    Examples:
    | adult_count | senior_citizen_count | children_count | infant_count | origin | destination | date         | fare_type | mobile_number | mail_id           |
    |  2          |       0              | 0             |0             | DEL    | MUM         | 30 Jun 2023  | Saver     | 9900990090    | johndoe@gmail.com |


  @BW-PE-AD-07 @NameFiled
  Scenario Outline: Verify the adult passenger information
    ...
    Examples:
      | adult_count | senior_citizen_count | children_count | infant_count | origin | destination | date         | fare_type | mobile_number | mail_id           |
      |  1          |       0              | 0             |0              | DEL    | MUM         | 20 Jun 2023  | Saver     | 9900990090    | johndoe@gmail.com |
    ...
    And user selects the date of birth as below for children
      | 14-May-2017 |
    Examples:
  |special_fare           | adult_count | senior_citizen_count | children_count | infant_count | origin | destination | date         | fare_type | mobile_number | mail_id           |
  |Unaccompanied Minor    |  1          |       0              | 0             |0              | DEL    | MUM         | 20 Jun 2023  | Saver     | 9900990090    | johndoe@gmail.com |
    ...
    | 14-Mar-2022 |
    Examples:
    |children_count  |senior_citizen_count | infant_count | adult_count |  origin | destination | date           | mobile_number | mail_id            | prefix | first_Name                     | last_Name                        | date_of_birth_infant | infant_gender | fare_type | index_of_adult_for_infant_tag |
    |    0           |        0             | 1            | 1           |  DEL    | CCU        | 27 Jun 2023    | 90009000900   | johndoe@gmail.com  | Mr     | Adolph Blaine Charles Davidson | William Xerxes Yancy Zeus Barnes | 14-May-2023          | male          | Saver     | 1                             |
    ...
    Examples:
        ...
        |Indigo@3557 |8668399124| Customer Login |BA3557524096   |  1          |       0              |  0            |0              | DOH    | DEL         | 10 Jun 2023  | Saver     | 9900990090    | johndoe@gmail.com |
    ...
    And user Enter the passport details "<PassportNumber>"to be updated for inbound booking for child
    Then user selects the Expiry Date of Passport for child
      |  30 Aug 2023|

      Examples:
      |PassportNumber | adult_count | senior_citizen_count | children_count | infant_count | origin | destination | date         | fare_type | mobile_number | mail_id           |
      |BA3557524096   |  0          |       0              |  1             |0              | DOH    | MUM         | 10 Jun 2023  | Saver     | 9900990090    | johndoe@gmail.com |
    ...
    Examples: Validation of fields of senior citizen and infant
     | children_count    |adult_count     | infant_count | senior_citizen_count | origin | destination | date             |  mobile_number | mail_id           | prefix | first_Name         | last_Name             | date_of_birth_senior |  fare_type |   SCID     |
     |       0           |      0         | 0            | 1                    | DEL    | CCU         | 27 Jun 2023      |  90009000900   | johndoe@gmail.com | Mr     | Adolph Blaine Charl| William Xerxes Yancy  | 14-Jun-1962          |  Saver     |   SC12345   |
...
#   Then Verify the sector fare details and fare breakup
  ...
  Examples:
 |children_count    | senior_citizen_count | adult_count | infant_count | origin | destination  | date             | mobile_number | mail_id           |  fare_type|
 |      0           |      0                | 1           | 0            | MUM    | DEL         | 30 Jun 2023      | 90009000900   | johndoe@gmail.com |  Saver    |

    @BW-PE-AD-14 @ @FirstTimeFlyer
    ...
    Examples:
      |children_count    | senior_citizen_count | adult_count | infant_count | origin | destination  | date             | mobile_number | mail_id           |  fare_type   |
      |      0           |      1               | 1           | 0            | MUM    | DEL          | 30 Jun 2023      | 90009000900   | johndoe@gmail.com | Flexi Plus   |
    ...
    Examples:
      |children_count    | senior_citizen_count | adult_count | infant_count | origin | destination  | date             | mobile_number | mail_id           |  fare_type   |
      |      0           |      1               | 0           | 0            | MUM    | DEL          | 30 Jun 2023      | 90009000900   | johndoe@gmail.com | Saver        |

#      # this test case is run on Agent Prod URL
      @BW-PE-AD-17 @AgentTest
      ...
      Then user verify that Orange banner message with change flight button
      Examples:
      | user_type      |username     | password     |children_count    | senior_citizen_count | adult_count | infant_count | origin | destination  | date             | mobile_number | mail_id           |  fare_type   |
      | Partner Login  | testweb     |Indigo@0001   |      0           |      1               | 0           | 0            | MUM    | DEL          | 30 Jun 2023      | 90009000900   | johndoe@gmail.com | Flexi Plus   |
    ...
    Examples: Validate wheelchair section
      ...
      | 1                             | 1           | 1               | 2           | 1                     | DEL    | MUM         |  28 Jun 2023   | Saver    | 9900990090            | johndoe@gmail.com |One Way   |
    ...
    Examples: Validate wheelchair section
      ...
      | 0             | 0               | 0            | 1                     | DEL    | MUM         |  30 Jun 2023    | Saver    | 9900990090 | johndoe@gmail.com |One Way   |
    ...
    Examples:
      | infant_count | children_count | adult_count | senior_citizen_count | origin | destination | date | fare_type | mobile_number | mail_id           |
      | 0            | 0              | 1         | 0                    | DEL     | MUM         |  28 Jun 2023    | Saver     | 9900990090    | johndoe@gmail.com |
   ...
   |Indigo@3333 | 8698760231  | Customer Login | 0            | 0              | 2          | 0                    | DEL     | MUM         |  28 Jun 2023    | Saver     | 9900990090    | johndoe@gmail.com |
    ...
    Examples:
    | trip_type | origin | destination | date          |srp_trip_type |fare_type|mobile_number  |mail_id          |
    | One Way   | DEL    | MUM         | 15 Jul 2023   |Multi-city    |Saver    | 9876456777    |abhii@gmail.com  |
